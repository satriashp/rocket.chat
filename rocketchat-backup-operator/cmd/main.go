...
import (
	...
	"github.com/satriashp/rocket.chat/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "88fd3850.satriashp.cloud",
	...
	if err := (&controller.RocketChatBackupReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "RocketChatBackup")
		os.Exit(1)
	}
